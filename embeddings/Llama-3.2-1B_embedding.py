...
parser = argparse.ArgumentParser(description='Generate Llama-3.2-1B embeddings for text datasets')
...
all_embeddings = []
print(f"Starting Llama embedding generation for {len(texts)} texts, batch_size={batch_size}")
for batch in tqdm(dataloader, desc="Llama Embedding", unit="batch"):
...
save_path = dataset + "/llama_"+ dataset +".npy"
