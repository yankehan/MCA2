...
import argparse
import traceback
parser = argparse.ArgumentParser(description='Generate OpenAI Ada embeddings for text datasets')
...
batch_dir = os.path.join(dataset, "openai_ada_batches")
...
end_time = time.time()
save_path = dataset + "/openai_ada_"+ dataset +".npy"
