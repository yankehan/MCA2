...
import argparse
import traceback
parser = argparse.ArgumentParser(description='Generate OpenAI Small embeddings for text datasets')
...
batch_dir = os.path.join(dataset, "openai_small_batches")
...
end_time = time.time()
save_path = dataset + "/openai_small_"+ dataset +".npy"
